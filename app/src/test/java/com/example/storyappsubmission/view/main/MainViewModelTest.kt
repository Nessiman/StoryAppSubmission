...
class MainViewModelTest {
    ...
    fun `when Get Story Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(mainRepository.getStory(context)).thenReturn(expectedStory)

        val mainViewModel = MainViewModel(mainRepository)
        val actualStory: PagingData<ListStoryItem> =
            mainViewModel.getAllStories(context).getOrAwaitValue()
    ...
    fun `when Get Story Empty Should Return No Data`() = runTest {
        ...
        val mainViewModel = MainViewModel(mainRepository)
        val actualStory: PagingData<ListStoryItem> = mainViewModel.getAllStories(context).getOrAwaitValue()
